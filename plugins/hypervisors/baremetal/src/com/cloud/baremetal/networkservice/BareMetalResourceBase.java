...
public class BareMetalResourceBase extends ManagerBase implements ServerResource {
    ...
    protected StartAnswer execute(StartCommand cmd) {
        ...
        if (_isEchoScAgent) {
            ...
            if(vm.getNics()[0].getIp() != null) {
                ipAddress = vm.getNics()[0].getIp().getHostAddress();
            }
            boolean echoRet = hc.echo(ipAddress, TimeUnit.MINUTES.toMillis(30), TimeUnit.MINUTES.toMillis(1));
            if (!echoRet) {
